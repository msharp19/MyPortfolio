...
namespace PortfolioSite.Utils
{
    ...
    {
        public static bool SendProgress(string connectionId, string progressMessage, bool limit)
        {
            ...
            hubContext.Clients.Client(connectionId).AddProgress(progressMessage, limit);
            return true;
        }
    }
}